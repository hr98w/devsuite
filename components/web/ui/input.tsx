...
export const inputVariants = cva({
  base: [
    "border appearance-none min-h-0 bg-transparent text-foreground rounded-lg break-words transition duration-150 placeholder:text-inherit placeholder:opacity-50 disabled:opacity-25",
